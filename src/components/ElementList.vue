<template>
  ...
  <div class="w-fit absolute">
    ...
    <div class="bg-neutral-900 shadow-lg p-2 h-[28rem] overflow-auto !text-neutral-200">
      ...
      <div class="button" @click="$emit('addElement', elements.header)">
      ...
      <div class="button" @click="$emit('addElement', elements.paragraph)">
      ...
      <div class="button" @click="$emit('addElement', elements.divider)">
      ...
      <div class="button" @click="$emit('addElement', elements.shortResponse)">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-text-left" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M2 12.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
        </svg>
        Short response
      </div>
      <div class="button" @click="$emit('addElement', elements.longResponse)">
      ...
      <!-- Choice response -->
      <p class="section">Choice</p>
      <div class="button" @click="$emit('addElement', elements.radio)">
      ...
      <div class="button" @click="$emit('addElement', elements.checkbox)">
      ...
      <div class="button" @click="$emit('addElement', elements.dropdown)">
      ...
      <div class="button" @click="$emit('addElement', elements.yesno)">
      ...
      <!-- Numeric response -->
      <p class="section">Numeric</p>
      <div class="button" @click="$emit('addElement', elements.number)">
      ...
      <!-- Time responses -->
      <p class="section">Time</p>
      <div class="button" @click="$emit('addElement', elements.date)">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
          <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
        </svg>
        Date
      </div>
      <div class="button" @click="$emit('addElement', elements.time)">
      ...
      <div class="button" @click="$emit('addElement', elements.datetime)">
      ...
      <div class="button" @click="$emit('addElement', elements.email)">
  ...
  data() {
    return {
      ...
      elements: {
        ...
        datetime: {
          type: 'date',
          question: 'Date and time question',
